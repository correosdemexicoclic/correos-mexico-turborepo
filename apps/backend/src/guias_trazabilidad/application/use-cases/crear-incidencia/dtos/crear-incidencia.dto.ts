...
export class CrearIncidenciaDto {
    @ApiProperty({ example: '17a84017-d931-4f8a-9766-462422a78a38', description: 'El numero de la guia' })
    ...
    @ApiProperty({ example: 'El paquete se extravio en el camino', description: 'La descripcion de la incidencia' })
    @IsString({ message: 'El campo descripcion debe ser una cadena de texto' })
    @IsNotEmpty({ message: 'El campo descripcion es requerido' })
    descripcion: string;

    @ApiProperty({ example: '1234567890', description: 'El id del responsable de la incidencia' })
