...
import { QR_GENERATOR_REPOSITORY, QRGeneratorRepositoryInterface } from "../../ports/outbound/qr-generator.repository.interface";
...
export class CrearQRCommandHandler implements ICommandHandler<CrearQRCommand>{
    ...
    async execute(command: CrearQRCommand): Promise<any> {
        ...
        const result = await this.qrRepository.generarQRComoTextoEnConsola(qrPayload)
